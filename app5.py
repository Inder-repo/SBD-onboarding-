...
def _rd_actions(req,user,is_sbd_mgr,assigned):
    ...
    if (assigned and req.get('architect_id')==user['id']) or is_sbd_mgr:
    ...
    # Engineer: notes
    if (assigned and req.get('engineer_id')==user['id']) or is_sbd_mgr:
    ...
    # Assurance: notes
    if (assigned and req.get('assurance_id')==user['id']) or is_sbd_mgr:
